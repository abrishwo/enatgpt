...
class AppIcon{
  ...
  static Widget aiImageIcon(BuildContext context) {
    return SvgPicture.asset(
      ...
      height: 30,
      width: 30,
      color: Colors.blue, //context.textTheme.headline1!.color,
    );
  }
  ...
  static Widget imageGeneratIcon() {
    return SvgPicture.asset(
      AppAssets.imageGeneratIcon,
      color: Colors.white,
      height: 20,
      width: 20,
    );
  ...
  static Widget deleteIcon(BuildContext context,{Color? color}) {
    return SvgPicture.asset(
      ...
      color: color ?? Colors.blue, //context.textTheme.headline1!.color,
      height: 20,
      width: 20,
    );
  }
...
class AppLottie{
  static Widget restoreLottie() {
    return Lottie.asset(
      AppAssets.restoreLoader,
